...
class PlantsControllerTest < ActionController::TestCase
  ...
  test "should create plant" do
    assert_difference('Plant.count') do
      post :create, plant: { date_planted: @plant.date_planted, name: @plant.name, placement: @plant.placement }
    end
  ...
  test "should update plant" do
    patch :update, id: @plant, plant: { date_planted: @plant.date_planted, name: @plant.name, placement: @plant.placement }
    assert_redirected_to plant_path(assigns(:plant))
  end
